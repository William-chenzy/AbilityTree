...
CommunicationTool::CommunicationTool(QWidget *parent) : QDialog(parent){
	ui.setupUi(this);
	...
	connect(&udp, &Udp::CallBack, this, &CommunicationTool::UdpCallBack);
	connect(&ftp, &Ftp::CallBack, this, &CommunicationTool::FtpCallBack);
	connect(&ts, &TcpSever::CallBack, this, &CommunicationTool::TcpSevCallBack);
	connect(&tc, &TcpClient::CallBack, this, &CommunicationTool::TcpCliCallBack);
	connect(&mtp, &ModbusTcpPoll::CallBack, this, &CommunicationTool::MtpCallBack);
	connect(&mts, &ModbusTcpSlave::CallBack, this, &CommunicationTool::MtsCallBack);
	connect(&mrp, &ModbusRtuPoll::CallBack, this, &CommunicationTool::MrpCallBack);
	connect(&mrs, &ModbusRtuSlave::CallBack, this, &CommunicationTool::MrsCallBack);
	connect(&ftpt, &QTimer::timeout, this, &CommunicationTool::DownloadOrUploadFiles);
	connect(&udpt, &QTimer::timeout, this, &CommunicationTool::on_pushButton_udp_send_clicked);
	connect(&tcpsev, &QTimer::timeout, this, &CommunicationTool::on_pushButton_tcp_sev_send_clicked);
	connect(&tcpcli, &QTimer::timeout, this, &CommunicationTool::on_pushButton_tcp_cli_send_clicked);
	...
	auto tab_set = [&](QTableWidget* p,bool t = false) {
		...
		connect(p, &QTableWidget::customContextMenuRequested, this, &CommunicationTool::ShowFtpMenu);
	};
...
void CommunicationTool::SwitchLanguage() {
	...
	ui.label_43->setText(LU_STR397);
	ui.label_36->setText(LU_STR397);
...
void CommunicationTool::TcpSevCallBack(Cb_type type, DataStu data) {
...
void CommunicationTool::TcpCliCallBack(Cb_type type, DataStu data) {
...
void CommunicationTool::UdpCallBack(Cb_type type, DataStu data) {
...
void CommunicationTool::FtpCallBack(Cb_type type, DataStu data) {
...
void CommunicationTool::MtsCallBack(Cb_type type, DataStu data) {
...
void CommunicationTool::MtpCallBack(Cb_type type, DataStu data) {
...
void CommunicationTool::MrsCallBack(Cb_type type, DataStu data) {
...
void CommunicationTool::MrpCallBack(Cb_type type, DataStu data) {
...
void CommunicationTool::AddMessageToLabel(QLabel* label, QString msg) {
...
void CommunicationTool::on_pushButton_tcp_sev_ok_clicked() {
...
void CommunicationTool::on_pushButton_tcp_cli_ok_clicked() {
...
void CommunicationTool::on_pushButton_mstcp_ok_clicked() {
...
void CommunicationTool::on_pushButton_mptcp_ok_clicked() {
...
void CommunicationTool::on_pushButton_msrtu_ok_clicked() {
...
void CommunicationTool::on_pushButton_mprtu_ok_clicked() {
...
void CommunicationTool::on_pushButton_tcp_sev_send_clicked() {
...
void CommunicationTool::on_pushButton_tcp_cli_send_clicked() {
...
void CommunicationTool::on_pushButton_udp_send_clicked() {
...
void CommunicationTool::on_checkBox_tcp_sev_auto_clicked() {
...
void CommunicationTool::on_checkBox_tcp_cli_auto_clicked() {
...
void CommunicationTool::on_checkBox_udp_auto_clicked() {
...
void CommunicationTool::on_comboBox_tcp_cli_currentIndexChanged(QString text) {
...
void CommunicationTool::on_tableWidget_itemDoubleClicked(QTableWidgetItem* item){
...
void CommunicationTool::on_tableWidget_2_itemDoubleClicked(QTableWidgetItem* item) {
...
void CommunicationTool::on_pushButton_ftp_refresh_2_clicked() {
	ui.pushButton_ftp_refresh_2->setEnabled(false);
	ftp.GetFileList();
	ui.pushButton_ftp_refresh_2->setEnabled(true);
}

void CommunicationTool::on_tableWidget_itemChanged(QTableWidgetItem* item) {
...
void CommunicationTool::on_tableWidget_2_itemChanged(QTableWidgetItem* item){
	if (item->column() != 1)return;
...
void CommunicationTool::on_tableWidget_mstcp_itemChanged(QTableWidgetItem* item) {
	auto row = item->row();
	auto col = item->column();
	int type = ui.comboBox_mstcp->currentIndex() + 1;
	mts.WriteDate(type, (ushort)item->text().toInt(), col * 10 + row);
}
void CommunicationTool::on_tableWidget_mptcp_itemDoubleClicked(QTableWidgetItem* item) {
	int type = ui.comboBox_mptcp->currentIndex() + 1;
	auto row = item->row();
	auto col = item->column();
...
void CommunicationTool::on_pushButton_mstcp_set_clicked(bool cur) {
...
void CommunicationTool::on_pushButton_mptcp_set_clicked(bool cur){
	static std::mutex lc_;
	if (!lc_.try_lock())return;
	if (!cur) {
...
void CommunicationTool::on_spinBox_mstcp_id_valueChanged(int val) { mts.SetSlaveId(val); }
void CommunicationTool::on_spinBox_mptcp_id_valueChanged(int val) { mtp.SetSlaveId(val); }
void CommunicationTool::on_spinBox_mptcp_valueChanged(int val) { mtp.SetScanTime(val); }

void CommunicationTool::on_tableWidget_msrtu_itemChanged(QTableWidgetItem* item) {
	auto row = item->row();
	auto col = item->column();
	int type = ui.comboBox_msrtu->currentIndex() + 1;
	mrs.WriteDate(type, (ushort)item->text().toInt(), col * 10 + row);
}
void CommunicationTool::on_tableWidget_mprtu_itemDoubleClicked(QTableWidgetItem* item) {
	int type = ui.comboBox_mprtu->currentIndex() + 1;
	auto row = item->row();
	auto col = item->column();
	if (type == 2 || type == 4)return;
...
void CommunicationTool::on_pushButton_msrtu_set_clicked(bool cur) {
	static std::mutex lc_;
	if (!lc_.try_lock())return;
	if (!cur) {
...
void CommunicationTool::on_pushButton_mprtu_set_clicked(bool cur) {
	static std::mutex lc_;
	if (!lc_.try_lock())return;
	if (!cur) {
...
void CommunicationTool::on_spinBox_msrtu_id_valueChanged(int val) { mrs.SetSlaveId(val); }
void CommunicationTool::on_spinBox_mprtu_id_valueChanged(int val) { mrp.SetSlaveId(val); }
void CommunicationTool::on_spinBox_mprtu_valueChanged(int val) { mrp.SetScanTime(val); }

void CommunicationTool::DownloadOrUploadFiles() {
...
void CommunicationTool::RefreshFtpTable(int mode) {
...
void CommunicationTool::on_tabWidget_currentChanged(int index) {
	if (index == 4) {
...
void CommunicationTool::on_comboBox_ftp_path_currentIndexChanged() {
...
void ModbusTcpPoll::CliCallBack(Communication::Cb_type type, Communication::DataStu data) {
	if (type == DisCONNECT || type == ConnECT) {
...
void ModbusRtuSlave::ComCallBack(Communication::Cb_type type, Communication::DataStu data) {
	if (type == DisCONNECT || type == ConnECT) {
		if (type == DisCONNECT) CallBack(type, { "",LU_STR268 });
		else CallBack(type, { "",LU_STR269 });
		l_s = type == DisCONNECT ? DISCONNECT : CONNECT;
...
void ModbusRtuPoll::ComCallBack(Communication::Cb_type type, Communication::DataStu data) {
	if (type == DisCONNECT || type == ConnECT) {
		if (type == DisCONNECT) CallBack(type, { "",LU_STR268 });
		else CallBack(type, { "",LU_STR269 });
		l_s = type == DisCONNECT ? DISCONNECT : CONNECT;

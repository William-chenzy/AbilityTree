...
PEReaderTool::PEReaderTool(QWidget *parent) :
	QMainWindow(parent), ui(new Ui::PEReaderTool)
{
	ui->setupUi(this);
	...
	ui->tableWidget->horizontalHeader()->setStyleSheet("QHeaderView::section{ background-color:rgb(27,29,33);}");
}

bool PEReaderTool::ReadFile() {
...
ULONG PEReaderTool::RvaToFoa(ULONG val) {
...
void PEReaderTool::on_lineEdit_rva_textChanged(QString msg) {
...
void PEReaderTool::on_pushButton_foa_clicked() {
...
void PEReaderTool::on_treeWidget_currentItemChanged(QTreeWidgetItem* current, QTreeWidgetItem* previous){
...
void PEReaderTool::dragEnterEvent(QDragEnterEvent* event)
{
...
void PEReaderTool::dropEvent(QDropEvent* event)
{
